  ...
  return (
    <div className='STEP'>
        ...
        <div className="step__container">
          ...
          <div className="step_div1 step__info step1">
            <img src="images/steps/1.gif" alt="step-img" />
          </div>
          
          <div className="step_div2 step__info step1">
          ...
          <div className="step_div3 step__info step2">
            <img src="images/steps/2.jpg" alt="step-img" />
          </div>
          
          <div className="step_div4 step__info step2">
          ...
          <div className="step_div5 step__info step3">
            <img src="images/steps/3.gif" alt="step-img" />
          </div>
          
          <div className="step_div6 step__info step3">
